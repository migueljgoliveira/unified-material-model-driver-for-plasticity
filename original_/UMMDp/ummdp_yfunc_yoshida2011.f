...
c
c     NUMISHEET 2011 Proceedings, AIP Conf. Proc.1383 (2011),
c     pp.807-814
c
c     "A user-friendly 3D yield function to describe anisotropy
c      of steel sheets ",IJP,v.45(2013), pp.1119-139. )
c
...
c
c------------------------------------------------------------
c     Weilong Hu & F.Yoshida style
c                             polynominal type yield function
c
