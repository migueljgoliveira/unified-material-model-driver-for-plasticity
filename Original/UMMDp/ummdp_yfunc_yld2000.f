...
c
c------------------------------------------------------------
c     calc. barlat-yld2k function x,y,phi (yld2000)
c
...
c                                           phi(1) and phi(2)
      ...
      nd=2
      phi(nd)=( abs(2.0d0*x(nd,1)+      x(nd,2)) )**em +
     &        ( abs(      x(nd,1)+2.0d0*x(nd,2)) )**em
c
      return
      end
c
c
c------------------------------------------------------------
c     set 1st order differential of parameters (yld2000)
c
...
c
c-------------------------------------------------------------
c     set 2nd order differential of parameters (yld2000)
c
